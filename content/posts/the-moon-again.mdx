...
date: "2026-04-09"
description: "NASA flew humans to the Moon for the first time in 53 years. It's a legacy project revival run in public. Here's what a space agency does on camera that software teams refuse to do, even when we watch it work."
...
There are lessons in here, and most of them are uncomfortable.
...
I think there is a word for this that we don't use often enough when we talk about legacy systems. The word is amnesty.
