...
## Skills in Action: An API Endpoint
...
No guessing about file names. No forgetting the test file. No inventing a new error format. The skill made every decision before you asked the question.
...
Agent: Checked src/routes/auth/ against api-endpoint skill.
  ...
  2 of 3 endpoints have issues.
```

The skill that taught the agent how to build the right thing also taught it how to spot the wrong thing. You wrote the rules once. Now they work in both directions.
