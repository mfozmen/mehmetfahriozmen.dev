  ...
  return (
    <section className="mb-20">
      ...
      <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-center">
        <div className="flex-1 space-y-4 text-neutral-400">
          <p>
            Systems are only half the story. I also build the teams that build
            them &mdash; hiring, mentoring, planning, and shipping together. And
            I&apos;ve always believed the best engineers are the ones who share
            what they know &mdash; through code reviews, open source
            contributions, or stepping on a stage.
          </p>
          <p>
            We&apos;re living through an AI revolution fueled by openly shared
            knowledge &mdash; open research, open source, open data. The
            engineers who build in the open aren&apos;t just growing themselves;
            they&apos;re shaping what comes next.
          </p>
        </div>
        <PhotoCaption
