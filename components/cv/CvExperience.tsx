          ...
          <div className="flex flex-col gap-0.5 sm:flex-row sm:items-baseline sm:justify-between">
            <div className="text-[13px]">
              {entry.subEntry.companyUrl ? (
                <CvLink href={entry.subEntry.companyUrl} className="font-semibold text-[#BA7517]" onClick={() => trackEvent("cv-company-click", { company: entry.subEntry!.company })}>{entry.subEntry.company}</CvLink>
              ) : (
